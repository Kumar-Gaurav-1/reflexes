...
// Pre-calculated constant offset array for corner samples
// 4 points: (5,5), (155,5), (5,115), (155,115) in a 160x120 grid
// Offset = (y * 160 + x) * 4
    ...
    if (prevFrameRef.current) {
      ...
      if (globalMotionSum < 400) {
        ...
        activeTargets.forEach(target => {
          ...
          // Clamped bounds for cache-friendly loops
          ...
          // Local High-Velocity "Snap" Signature detection (row-major memory access)
