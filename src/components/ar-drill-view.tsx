    ...
    if (prevFrameRef.current) {
      ...
      if (globalMotionSum < 400) {
        ...
        activeTargets.forEach(target => {
          ...
          // Bolt Performance: Pre-clamp loop boundaries to avoid inner loop bounds checking.
          // In a hot loop like this (running per target, per frame), doing conditional bounds
          // checks (x < 0, etc.) on every pixel iteration slows things down.
