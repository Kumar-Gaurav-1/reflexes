...
// Pre-calculate corner offsets for 160x120 canvas to avoid recreation in render loop
    ...
    if (prevFrameRef.current) {
      ...
      if (globalMotionSum < 400) {
        ...
        activeTargets.forEach(target => {
          ...
          // Calculate loop bounds outside inner loop
          ...
          // Loop with y on the outside, x on the inside to utilize continuous memory access
